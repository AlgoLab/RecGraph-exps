...
for GENE in $GENES; do
    for ERR in "${ERRORS[@]}"; do
        for REC in "${RECS[@]}"; do
            INPUT_FILE="output/HLA_full/genes/${GENE}/${REC}/reads_${ERR}.fa"
            OUTPUT_DIR="output/HLA_full/genes/${GENE}/${REC}/reads_${ERR}_split"
    ...
    rm -f output/HLA_full/genes/${GENE}/reads_0.fa
done